...
class PyCalcUi(QMainWindow):
    ...
    def _createClock(self):
        ...
        self.clock.setFixedHeight(35)
        self.clock.setAlignment(Qt.AlignTop)
        # Add the display to the general layout
        self.generalLayout.addWidget(self.clock)
    ...
    def showTime(self):
        ...
        clock_time = current_time.toString('hh:mm:ss')
  
        # showing it to the label
        self.clock.setText(clock_time)
    ...
    def cycleSkin(self):
        self.clock.setStyleSheet("background-color: yellow; border: 1px solid black;")
...
class PyCalcCtrl:
    ...
    def _connectSignals(self):
        ...
        for btnText, btn in self._view.buttons.items():
            if btnText not in {'=', 'C', 'CS'}:
                btn.clicked.connect(partial(self._buildExpression, btnText))

        self._view.buttons['='].clicked.connect(self._calculateResult)
        self._view.display.returnPressed.connect(self._calculateResult)
        self._view.buttons['C'].clicked.connect(self._view.clearDisplay)
        self._view.buttons['CS'].clicked.connect(self._view.cycleSkin)
